...
public class PlayerSave {
		...
		while (EndOfFile == false && line != null) {
			...
			if (spot > -1) {
				...
				case 2:
					if (token.equals("character-height")) {
					...
					} else if (token.equals("tutorialIslandStage")) {
						TutorialIsland.tutorialIslandStage = Integer.parseInt(token2);
						...
						p.randomActions = Integer.parseInt(token2);
						...
						p.questStages = Integer.parseInt(token2);
						...
						p.lastH = Integer.parseInt(token2);
						...
						p.bankPin1 = Integer.parseInt(token2);
						  ...
						  p.muteTime = Long.parseLong(token2);
	...
	public static boolean saveGame(Client p) {
		...
		try {
			...
			characterfile.write(Long.toString(p.muteTime), 0, Long.toString(p.muteTime).length());
			characterfile.newLine();
			characterfile.write("tutorialIslandStage = ", 0, 22);
			characterfile.write(Integer.toString(TutorialIsland.tutorialIslandStage), 0, Integer.toString(TutorialIsland.tutorialIslandStage).length());
			characterfile.newLine();
			characterfile.write("ptjob = ", 0, 8);
			characterfile.write(Integer.toString(p.ptjob), 0, Integer.toString(p.ptjob).length());
			characterfile.newLine();
			...
			characterfile.write(Integer.toString(p.questStages), 0,
					Integer.toString(p.questStages).length());
			characterfile.newLine();
			...
			characterfile.write(Integer.toString(p.randomActions), 0,
					Integer.toString(p.randomActions).length());
			characterfile.newLine();
			...
			characterfile.write(Integer.toString(p.lastX), 0, Integer
					.toString(p.lastX).length());
			characterfile.newLine();
			characterfile.write("lastY = ", 0, 8);
			characterfile.write(Integer.toString(p.lastY), 0, Integer
					.toString(p.lastY).length());
			characterfile.newLine();
			characterfile.write("lastH = ", 0, 8);
			characterfile.write(Integer.toString(p.lastH), 0, Integer
					.toString(p.lastH).length());
			characterfile.newLine();
			...
			characterfile.write(Boolean.toString(p.membership), 0, Boolean
					.toString(p.membership).length());
			characterfile.newLine();
			...
			characterfile.write(Boolean.toString(p.musicOn), 0, Boolean.toString(p.musicOn).length());
			characterfile.newLine();
			...
			characterfile.write(Integer.toString(p.bananas), 0, Integer
					.toString(p.bananas).length());
			characterfile.newLine();
			characterfile.write("runeMist = ", 0, 11);
			characterfile.write(Integer.toString(p.runeMist), 0, Integer.toString(p.runeMist).length());
			characterfile.newLine();
			characterfile.write("cookAss = ", 0, 10);
			characterfile.write(Integer.toString(p.cookAss), 0, Integer
					.toString(p.cookAss).length());
			characterfile.newLine();
			...
			characterfile.write(Integer.toString(p.impsC), 0, Integer
					.toString(p.impsC).length());
			characterfile.newLine();
			characterfile.write("sheepShear = ", 0, 13);
			characterfile.write(Integer.toString(p.sheepShear), 0,
					Integer.toString(p.sheepShear).length());
			characterfile.newLine();
			characterfile.write("romeo-juliet = ", 0, 15);
			characterfile.write(Integer.toString(p.romeojuliet), 0, Integer.toString(p.romeojuliet).length());
			characterfile.newLine();
			characterfile.write("gertCat = ", 0, 10);
			characterfile.write(Integer.toString(p.gertCat), 0, Integer.toString(p.gertCat).length());
			characterfile.newLine();
			...
			characterfile.write(Integer.toString(p.restGhost), 0, Integer.toString(p.restGhost).length());
			characterfile.newLine();
			characterfile.write("vampSlayer = ", 0, 13);
			characterfile.write(Integer.toString(p.vampSlayer), 0, Integer.toString(p.vampSlayer).length());
			characterfile.newLine();
