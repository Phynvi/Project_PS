...
public class Specials {
    ...
    public void activateSpecial(int weapon, int i) {
        ...
        if (NPCHandler.npcs[i] == null && c.npcIndex > 0 || PlayerHandler.players[c.playerIndex] == null && c.playerIndex > 0) {
		    return;
		}
        c.doubleHit = false;
        c.specEffect = 0;
        ...
        c.delayedDamage = Misc.random(c.getCombat().meleeMaxHit());
        c.delayedDamage2 = Misc.random(c.getCombat().meleeMaxHit());
