...
public class CombatAssistant {
	...
	public void applyNpcMeleeDamage(int i, int damageMask) {
		int damage = Misc.random(c.getCombat().meleeMaxHit());
	...
	public void attackPlayer(int i) {
		...
		if (PlayerHandler.players[i] != null) {
			...
			if (c.getPA().getWearingAmount() < 4 && c.duelStatus < 1 && !c.inCw() && c.inPits == false) {
	...
	public int calculateRangeDefence() {
		return RangeData.calculateRangeDefence(c);
	}
	
	public int calculateRangeAttack() {
		return RangeData.calculateRangeAttack(c);
	}
	...
	public int mageDef() {
		return MagicData.mageDef(c);
	}
	
	public int mageAtk() {
		return MagicData.mageAtk(c);
	}
