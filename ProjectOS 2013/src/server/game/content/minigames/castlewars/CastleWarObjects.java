...
public class CastleWarObjects {
    ...
    public static void handleObject(Client c, int id, int x, int y) {
        if (!CastleWars.isInCw(c)) {
            //c.sendMessage("You have to be in castle wars to use these objects.");
            //CastleWars.resetPlayer(c);
            //return;
        }
        switch (id) {
            case 4469:
            ...
            case 4459: // tinderbox table
            	if (System.currentTimeMillis() - c.miscTimer > 1200) {
    			c.sendMessage("You take a tinderbox!");
            ...
            case 4462:
            	if (System.currentTimeMillis() - c.miscTimer > 1200) {
        			c.sendMessage("You take some rope!");
            ...
            case 4460:
            	if (System.currentTimeMillis() - c.miscTimer > 1200) {
        			c.sendMessage("You take a rock!");
        			c.getItems().addItem(4043, 1);
        			c.miscTimer = System.currentTimeMillis();
                	}
        	break;
            case 4900:
