...
public class CastleWars {
    ...
    public static void resetPlayer(Client c) {
    	   c.getPA().movePlayer(2440 + Misc.random(3), 3089 - Misc.random(3), 0);
    	   c.sendMessage("Cheating will not be tolerated.");
    }
    ...
    public static void removePlayerFromCw(Client player) {
        ...
        if (gameRoom.containsKey(player)) {
            ...
            player.sendMessage("The Casle Wars Game has ended for you!");
            player.sendMessage("Kills: " + player.cwKills + " Deaths: " + player.cwDeaths + ".");
            player.getPA().createPlayerHints(10, -1);
