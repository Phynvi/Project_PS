...
public class PestControl {
    ...
    private void startGame() {
        ...
        for (Client player : waitingBoat.keySet()) {
            ...
            FreeDialogues.handledialogue(player, 599, 3790);
    ...
    private void endGame(boolean won) {
        for (Client player : gamePlayers.keySet()) {
            ...
            if (won && player.pcDamage > 50) {
                FreeDialogues.handledialogue(player, 598, 3790);
                int POINT_REWARD = 8;
                ...
                player.getItems().addItem(995, player.combatLevel * 10);
            	 ...
            	 FreeDialogues.handledialogue(player, 596, 3790);
                int POINT_REWARD2 = 6;
                player.pcPoints += POINT_REWARD2;
                player.sendMessage("The void knights notice your lack of zeal. You only gain " + POINT_REWARD2 + " points.");
            } else {
            	FreeDialogues.handledialogue(player, 597, 3790);
