...
public class ObjectManager {
	...
	public void loadObjects(Client c) {
		...
		loadCustomSpawns(c);
		c.getPA().checkObjectSpawn(-1, 3236, 3295, 0, 0);
		c.getPA().checkObjectSpawn(-1, 3236, 3296, 0, 0);
		c.getPA().checkObjectSpawn(-1, 3253, 3266, 0, 0);
		c.getPA().checkObjectSpawn(-1, 3253, 3267, 0, 0);
		c.getPA().checkObjectSpawn(-1, 3164, 3433, 0, 0);
		c.getPA().checkObjectSpawn(-1, 1520, 3219, 0, 0);
		c.getPA().checkObjectSpawn(-1, 3217, 3218, 0, 0);
	...
	public void loadCustomSpawns(Client client) {
		if(client.flourAmount > 0 && client.heightLevel == 0)
			client.getPA().checkObjectSpawn(FlourMill.FULL_FLOUR_BIN, 3166, 3306, 0, 10);
