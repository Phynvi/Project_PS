...
public class Constants {
	 ...
	 */
	public static final String MESSAGE_OF_THE_WEEK = Constants.SERVER_NAME + " is currently in the beta stage, feel free to report any bugs you find.";
	 ...
	 * The server's name.
	 */
	public static final String SERVER_NAME = "Rs2-Server";
