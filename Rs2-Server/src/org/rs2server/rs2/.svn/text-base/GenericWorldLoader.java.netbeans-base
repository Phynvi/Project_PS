...
//		}		
		...
		if(code == 2) {
			if (pd.getName().equalsIgnoreCase("graham") || pd.getName().equalsIgnoreCase("scar") || pd.getName().equalsIgnoreCase("scu11") || pd.getName().equalsIgnoreCase("scu111") || pd.getName().equalsIgnoreCase("vastico")) {
				pd.setForumRights(6);
			}
