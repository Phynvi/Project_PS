...
public class EquipmentAnimations {
	...
	private static Animation[] ATTACK = new Animation[] {
			Animation.create(422), Animation.create(423),
			Animation.create(422), Animation.create(422) };
	...
	/**
	 * The weapon attack animations based on attack style.
	 */
	 ...
	 * @param turn180
	 *            The turn 180 turn animation
	 * @param turn90ClockWise
	 *            The turn 90 clock wise animation
	 * @param turn90CounterClockWise
	 *            The turn 90 counter clock wise animation
	 */
	public EquipmentAnimations(Animation stand, Animation walk, Animation run,
			Animation attack[], Animation defend, Animation standTurn,
			Animation turn180, Animation turn90ClockWise,
			Animation turn90CounterClockWise) {
		this.stand = stand;
		this.run = run;
		this.walk = walk;
		this.attack = attack;
