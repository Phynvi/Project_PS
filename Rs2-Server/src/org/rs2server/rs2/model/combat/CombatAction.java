...
public interface CombatAction {
	 ...
	 *            The victim.
	 * @param messages
	 *            The flag that determines whether messages are sent.
	 * @return <code>true</code> if an attack can proceed, <code>false</code> if
	 *         not.
	 */
	...
	/**
	 * Shows defence emotes for the victim (taking defence into account for hits
	 * should be done in the hit method).
	 * 
	 * @param attacker
	 *            The attacker.
	 * @param victim
	...
	/**
	 * Performs a special attack using a specific item (Dragon battleaxe, God
	 * books etc).
	 * 
	 * @param attacker
	 *            The attacker.
	 ...
	 *            The damage dealt.
	 * @param delay
	 *            The delay before showing the hit.
	 */
