...
public class NPCDefinition {
	 ...
	 * Logger instance.
	 */
	private static final Logger logger = Logger.getLogger(NPCDefinition.class
			.getName());
			...
			for (int i = 0; i < definitions.length; i++) {
				...
				if (npc != null) {
					...
					if (npc.getDescription() != null
							&& !npc.getDescription().equalsIgnoreCase("null")) {
	...
	public static void init() throws IOException {
		...
		RandomAccessFile raf = new RandomAccessFile("data/npcDefinitions.bin",
				"r");
		try {
	 ...
	 *            The id.
	 */
	public NPCDefinition(int id, String name, String description,
			int combatLevel, int size, String[] interactionMenu) {
		this.id = id;
		this.name = name;
