		...
		try {
			...
			case 459:
				...
				player.getActionQueue().addAction(
						new Crafting(player, null, null, amount));
				break;
			...
			case 306:
				if (player.getInterfaceAttribute("fletching_log") != null
						&& player.getInterfaceAttribute("fletching_index") != null) {
					player.getActionQueue()
							.addAction(
									new Fletching(
											...
											amount,
											(Integer) player
													.getInterfaceAttribute("fletching_index"),
											(Log) player
						...
						player.getActionQueue()
								.addAction(
										new Herblore(
												player,
												amount,
												PrimaryIngredient.forId((Integer) player
						...
						player.getActionQueue()
								.addAction(
										new Herblore(
												...
												amount,
												null,
												SecondaryIngredient.forId((Integer) player
														.getInterfaceAttribute("herblore_index")),
