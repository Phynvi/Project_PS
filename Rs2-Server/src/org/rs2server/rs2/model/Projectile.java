...
public class Projectile {
	 ...
	 */
	public static Projectile create(Location start, Location finish, int id,
			int delay, int angle, int speed, int startHeight, int endHeight,
			int lockon, int slope, int radius) {
		return new Projectile(start, finish, id, delay, angle, speed,
				startHeight, endHeight, lockon, slope, radius);
	}
	 ...
	 *            The delay.
	 */
	private Projectile(Location start, Location finish, int id, int delay,
			int angle, int speed, int startHeight, int endHeight, int lockon,
			int slope, int radius) {
		this.id = id;
		this.delay = delay;
		this.start = start;
		this.finish = finish;
