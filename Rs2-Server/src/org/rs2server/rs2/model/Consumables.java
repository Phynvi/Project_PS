...
public class Consumables {
	...
	public static enum Drink {
		...
		ATTACK_POTION(new int[] { 125, 123, 121, 2428 },
				new int[] { Skills.ATTACK }, PotionType.NORMAL_POTION),

		STRENGTH_POTION(new int[] { 119, 117, 115, 113 },
				new int[] { Skills.STRENGTH }, PotionType.NORMAL_POTION),

		DEFENCE_POTION(new int[] { 137, 135, 133, 2432 },
				new int[] { Skills.DEFENCE }, PotionType.NORMAL_POTION),

		RANGE_POTION(new int[] { 173, 171, 169, 2444 },
				new int[] { Skills.RANGE }, PotionType.NORMAL_POTION),

		MAGIC_POTION(new int[] { 3046, 3044, 3042, 3040 },
				new int[] { Skills.MAGIC }, PotionType.PLUS_5),

		RESTORE_POTION(new int[] { 131, 129, 127, 2430 }, new int[] {
				Skills.DEFENCE, Skills.ATTACK, Skills.STRENGTH, Skills.MAGIC,
				Skills.RANGE }, PotionType.RESTORE),

		SUPER_RESTORE_POTION(new int[] { 3030, 3028, 3026, 3024 }, new int[] {
				Skills.ATTACK, Skills.STRENGTH, Skills.DEFENCE, Skills.MAGIC,
				Skills.RANGE, Skills.PRAYER, Skills.AGILITY, Skills.COOKING,
		...
		PRAYER_POTION(new int[] { 143, 141, 139, 2434 },
				new int[] { Skills.PRAYER }, PotionType.PRAYER_POTION),

		SUPER_ATTACK_POTION(new int[] { 149, 147, 145, 2436 },
				new int[] { Skills.ATTACK }, PotionType.SUPER_POTION),

		SUPER_STRENGTH_POTION(new int[] { 161, 159, 157, 2440 },
				new int[] { Skills.STRENGTH }, PotionType.SUPER_POTION),

		SUPER_DEFENCE_POTION(new int[] { 167, 165, 163, 2442 },
				new int[] { Skills.DEFENCE }, PotionType.SUPER_POTION),

		SARADOMIN_BREW(new int[] { 6691, 6689, 6687, 6685 }, new int[] {
				Skills.ATTACK, Skills.DEFENCE, Skills.STRENGTH, Skills.MAGIC,
				Skills.RANGE, Skills.HITPOINTS }, PotionType.SARADOMIN_BREW),

		ZAMORAK_BREW(new int[] { 193, 191, 189, 2450 }, new int[] {
				Skills.ATTACK, Skills.STRENGTH, Skills.DEFENCE,
				Skills.HITPOINTS, Skills.PRAYER }, PotionType.ZAMORAK_BREW),

		ANTIPOISON(new int[] { 179, 177, 175, 2446 }, new int[] {},
				PotionType.ANTIPOISON),

		SUPER_ANTIPOISON(new int[] { 185, 183, 181, 2448 }, new int[] {},
				PotionType.SUPER_ANTIPOISON),

		BEER(new int[] { 1919, 1917 }, new int[] { Skills.ATTACK,
				Skills.STRENGTH }, PotionType.BEER),

		JUG(new int[] { 1935, 1993 }, new int[] { Skills.ATTACK,
				Skills.HITPOINTS }, PotionType.WINE);
	...
	public static enum PotionType {
		NORMAL_POTION(0), SUPER_POTION(1), SARADOMIN_BREW(2), ZAMORAK_BREW(3), PLUS_5(
				4), RESTORE(5), SUPER_RESTORE(6), PRAYER_POTION(7), ANTIPOISON(
				8), SUPER_ANTIPOISON(9), BEER(10), WINE(11);
