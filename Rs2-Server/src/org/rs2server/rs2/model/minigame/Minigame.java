...
public interface Minigame {
	...
	/**
	 * An enum that represents the state in which items are lost/kept upon
	 * death.
	 * 
	 * @author Michael
	 * 
	 ...
	 * 
	 * @return A tickable that performs actions such as depleting remaining
	 *         time.
	 */
	...
	/**
	 * Gets the location that the player is teleported to upon quitting the
	 * game.
	 * 
	 * @return The location that the player is teleported to upon quitting the
	 *         game.
	 */
