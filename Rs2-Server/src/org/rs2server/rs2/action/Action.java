...
public abstract class Action {
	...
	/**
	 * An animation policy determines if the action should reset animations when
	 * cancelled.
	 * 
	 * @author Graham Edgecombe
	 * 
	...
	/**
	 * A stack policy determines whether this action should be stopped by other
	 * actions.
	 * 
	 * @author Graham Edgecombe
	 * 
